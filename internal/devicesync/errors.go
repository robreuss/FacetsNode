...
const (
	...
	CodeInvalidJoinRequest   ErrorCode = "invalid_device_sync_join_request"
	CodeJoinRequestNotFound  ErrorCode = "device_sync_join_request_not_found"
	CodeJoinRequestExpired   ErrorCode = "device_sync_join_request_expired"
	CodeJoinRequestClaimed   ErrorCode = "device_sync_join_request_claimed"
	CodeJoinRequestCollision ErrorCode = "device_sync_join_request_collision"
)
