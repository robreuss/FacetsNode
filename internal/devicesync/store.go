...
type Store interface {
	...
	CreateSpaceDeviceAdmission(context.Context, SpaceSponsorCredential, SpaceDeviceAdmission, int64) (SpaceDeviceAdmissionCreateResult, error)
	CancelSpaceDeviceAdmission(context.Context, SpaceSponsorCredential, SpaceDeviceAdmissionCancellation, int64) (SpaceDeviceAdmissionCancellationResult, error)
	...
	CancelJoinRequest(context.Context, JoinRequestCredential) error
