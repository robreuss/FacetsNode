...
const (
	...
	CodeInvalidProvisioningAdmission     ErrorCode = "invalid_shared_space_provisioning_admission"
	CodeProvisioningAdmissionCollision   ErrorCode = "shared_space_provisioning_admission_collision"
	CodeProvisioningAdmissionNotFound    ErrorCode = "shared_space_provisioning_admission_not_found"
	CodeProvisioningAdmissionClaimed     ErrorCode = "shared_space_provisioning_admission_claimed"
	CodeProvisioningAdmissionExpired     ErrorCode = "shared_space_provisioning_admission_expired"
	...
	CodeInvalidComputeBinding            ErrorCode = "invalid_shared_space_compute_binding"
	CodeComputeBindingCollision          ErrorCode = "shared_space_compute_binding_collision"
	CodeComputeBindingNotFound           ErrorCode = "shared_space_compute_binding_not_found"
