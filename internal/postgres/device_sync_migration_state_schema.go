...
var deviceSyncMigrationTableSpecs = []deviceSyncMigrationTableSpec{
	...
	migrationTable("device_sync_discovery_profiles", "principal_id", []string{"principal_id"},
		migrationUUID("principal_id"), migrationInt16("version"),
		migrationText("set_discriminator"), migrationText("display_name"),
		migrationInt64("revision"), migrationInt64("updated_at_milliseconds")),
	...
	migrationTable("device_sync_space_device_admissions", "principal_id", []string{"principal_id", "space_id", "admission_id"},
		...
		migrationUUID("admission_id"), migrationInt16("version"), migrationJSON("sponsor_binding"),
		migrationInt64("created_at_milliseconds"), migrationInt64("claimed_at_milliseconds", true),
		migrationUUID("claimed_member_id", true)),
	migrationTable("device_sync_space_admission_cancellations", "principal_id", []string{"principal_id", "space_id", "admission_id"},
		migrationUUID("principal_id"), migrationUUID("space_id"), migrationUUID("admission_id"),
		migrationUUID("retry_id"), migrationUUID("device_id"), migrationUUID("sponsor_device_id")),
	...
	migrationTable("device_sync_object_scope_clocks", "principal_id", []string{"principal_id"},
		migrationUUID("principal_id"), migrationInt64("observed_at_ms")),
	migrationTable("device_sync_object_scope_consents", "principal_id", []string{"principal_id", "reference_digest"},
		migrationUUID("principal_id"), migrationUUID("space_id"), migrationText("reference_digest"),
		migrationUUID("binding_id"), migrationUUID("link_id"), migrationText("link_intent_digest"),
		migrationColumn("canonical_consent", deviceSyncMigrationScalarBytes, "bytea"),
		migrationInt64("accepted_at_ms"), migrationInt64("withdrawn_at_ms", true)),
	migrationTable("device_sync_object_scope_mutations", "principal_id", []string{"principal_id", "retry_id"},
		migrationUUID("principal_id"), migrationUUID("retry_id"), migrationText("reference_digest"),
		migrationColumn("canonical_mutation", deviceSyncMigrationScalarBytes, "bytea"),
		migrationUUID("participant_device_id"), migrationUUID("control_subscription_id"),
		migrationUUID("space_subscription_id"), migrationInt64("applied_at_ms")),
...
var deviceSyncMigrationOmittedColumns = map[string]map[string]string{
	...
	"device_sync_discovery_profiles":               {"stored_at": "timestamptz"},
